    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <span
            className={`inline-flex px-4 py-2 rounded-full text-sm font-bold border-2 ${statusColors[returnRequest.status] || "bg-gray-100 text-gray-800 border-gray-300"}`}
          >
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-2 border-gray-200">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">
                  {returnRequest.requestType === "CANCELLATION"
                    ? "İptal Talebi"
                    : "Ürün İadesi"}
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 pt-3 border-t border-gray-200">
                <div>
                  ...
                  <p className="text-sm text-gray-900">
                    {formatDateToTurkey(returnRequest.createdAt)}
                  </p>
                </div>
                {returnRequest.processedAt && (
                  <div>
                    ...
                    <p className="text-sm text-gray-900">
                      {formatDateToTurkey(returnRequest.processedAt)}
                    </p>
                  </div>
                )}
              </div>
                ...
                {returnRequest.items.map((item) => (
                  ...
                  >
                    <p className="text-sm text-gray-600">
                      Sipariş Öğesi ID: #{item.orderItemId}
                    </p>
                    <p className="font-semibold text-gray-900">
