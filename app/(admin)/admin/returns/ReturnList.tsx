              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className="inline-flex px-3 py-1 rounded-full text-xs font-bold border-2 bg-gray-100 text-gray-800 border-gray-200">
                    {returnItem.requestType === "CANCELLATION"
                      ? "İptal Talebi"
                      : "İade"}
                  </span>
                </td>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <span
                    className={`inline-flex px-3 py-1 rounded-full text-xs font-bold border-2 ${statusColors[returnItem.status] || "bg-gray-100 text-gray-800 border-gray-300"}`}
                  >
