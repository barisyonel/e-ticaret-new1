...
export default async function UserDetailPage({
  ...
  const { OrderRepository } =
    await import("@/lib/repositories/OrderRepository");
  ...
  const { UserAddressRepository } =
    await import("@/lib/repositories/UserAddressRepository");
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Kullanıcı bilgileri, siparişler ve adresler
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-start gap-6">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span
                className={`inline-flex px-3 py-1 rounded-full text-xs font-bold border-2 ${roleColors[user.role] || "bg-gray-100 text-gray-800 border-gray-300"}`}
              >
            ...
            <p className="text-sm text-gray-500">
              Kayıt Tarihi: {formatDateToTurkey(user.createdAt)}
            </p>
          </div>
        </div>
      </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <span
                        className={`inline-flex px-2 py-1 rounded-full text-xs font-bold border ${statusColors[order.status] || "bg-gray-100 text-gray-800"}`}
                      >
