...
} from "@/app/server-actions/reportActions";
...
export default async function AdminReportsPage({ searchParams }: PageProps) {
  ...
  const salesReport =
    salesReportResult.success && salesReportResult.data
      ? salesReportResult.data
      : [];
  const productReport =
    productReportResult.success && productReportResult.data
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          {salesReport.length > 0 ? (
            ...
            <p className="text-gray-500">
              Seçilen tarih aralığında satış bulunmamaktadır.
            </p>
          )}
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          {productReport.length > 0 ? (
            ...
            <p className="text-gray-500">
              Seçilen tarih aralığında ürün satışı bulunmamaktadır.
            </p>
          )}
        </div>
      </div>
