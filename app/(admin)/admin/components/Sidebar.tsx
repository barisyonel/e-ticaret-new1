      ...
      icon: (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M7.5 7.5h-.75A2.25 2.25 0 004.5 9.75v7.5a2.25 2.25 0 002.25 2.25h7.5a2.25 2.25 0 002.25-2.25v-7.5a2.25 2.25 0 00-2.25-2.25h-.75m-6 3.75l3 3m0 0l3-3m-3 3V1.5m6 9h.75a2.25 2.25 0 012.25 2.25v7.5a2.25 2.25 0 01-2.25 2.25h-7.5a2.25 2.25 0 01-2.25-2.25v-7.5a2.25 2.25 0 012.25-2.25h.75m-6-3.75l3 3m0 0l3-3m-3 3V7.5m6 9h.75a2.25 2.25 0 002.25 2.25v7.5a2.25 2.25 0 01-2.25 2.25h-7.5a2.25 2.25 0 01-2.25-2.25v-7.5a2.25 2.25 0 012.25-2.25h.75"
          />
        </svg>
      ),
    },
    ...
    <aside className="hidden lg:flex flex-col w-64 bg-white min-h-[calc(100vh-64px)] border-r border-gray-200">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <path
              ...
              strokeLinejoin="round"
              strokeWidth={2}
              d="M19 21V5a2 2 0 00-2-2H7a2 2.25 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"
            />
          </svg>
      ...
      <nav className="flex-1 overflow-y-auto py-4">
        <div className="space-y-1 px-3">
          ...
          >
            <div
              className={`flex-shrink-0 ${isActive("/admin") ? "text-primary-blue" : "text-gray-400 group-hover:text-gray-600"}`}
            >
              {navItems[0].icon}
            </div>
          ...
          >
            <div
              className={`flex-shrink-0 ${isActive("/admin/orders") ? "text-primary-blue" : "text-gray-400 group-hover:text-gray-600"}`}
            >
              {navItems[1].icon}
            </div>
          ...
          >
            <div
              className={`flex-shrink-0 ${isActive("/admin/products") ? "text-primary-blue" : "text-gray-400 group-hover:text-gray-600"}`}
            >
              {navItems[2].icon}
            </div>
          ...
          >
            <div
              className={`flex-shrink-0 ${isActive("/admin/categories") ? "text-primary-blue" : "text-gray-400 group-hover:text-gray-600"}`}
            >
              {navItems[3].icon}
            </div>
          ...
          >
            <div
              className={`flex-shrink-0 ${isActive("/admin/attributes") ? "text-primary-blue" : "text-gray-400 group-hover:text-gray-600"}`}
            >
              {navItems[4].icon}
            </div>
          ...
          >
            <div
              className={`flex-shrink-0 ${isActive("/admin/coupons") ? "text-primary-blue" : "text-gray-400 group-hover:text-gray-600"}`}
            >
              <svg
                className="w-6 h-6"
                fill="none"
          ...
          >
            <div
              className={`flex-shrink-0 ${isActive("/admin/returns") ? "text-primary-blue" : "text-gray-400 group-hover:text-gray-600"}`}
            >
              <svg
                className="w-6 h-6"
                fill="none"
          ...
          >
            <div
              className={`flex-shrink-0 ${isActive("/admin/reviews") ? "text-primary-blue" : "text-gray-400 group-hover:text-gray-600"}`}
            >
              <svg
                className="w-6 h-6"
                fill="none"
          ...
          >
            <div
              className={`flex-shrink-0 ${isActive("/admin/users") ? "text-primary-blue" : "text-gray-400 group-hover:text-gray-600"}`}
            >
              {navItems[5].icon}
            </div>
          ...
          >
            <div
              className={`flex-shrink-0 ${isActive("/admin/reports") ? "text-primary-blue" : "text-gray-400 group-hover:text-gray-600"}`}
            >
              {navItems[6].icon}
            </div>
          ...
          >
            <div
              className={`flex-shrink-0 ${isActive("/admin/randevular") ? "text-primary-blue" : "text-gray-400 group-hover:text-gray-600"}`}
            >
              {navItems[7].icon}
            </div>
